    ...
    <section className="py-24 bg-primary text-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link href={user ? "/dashboard" : "/signup"} className="w-full sm:w-auto bg-accent text-primary px-10 py-5 rounded-2xl font-black text-xl hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-accent/20">
